...
//    }
    ...
    public boolean sendEmailWithAttachment(String userName, String mailId, String subject, String mailContent, byte[] attachmentBytes, String attachmentFileName) {
        try {
            String senderName = "Film-hook IT-Support";
            ...
            helper.setTo(mailId);
            helper.setSubject(subject);
            helper.setText(finalMailContent, true); // true = HTML
