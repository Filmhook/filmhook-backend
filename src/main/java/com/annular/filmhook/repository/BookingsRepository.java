...
public interface BookingsRepository extends JpaRepository<Bookings, Integer> {
    ...
    @Query("Select br From Bookings br Where br.bookingStatus = 'Confirm' and br.bookedUser = :bookedUser and br.status = true Order by br.toDate desc")
    List<Bookings> getConfirmedBookingsByBookedUser(User bookedUser);
