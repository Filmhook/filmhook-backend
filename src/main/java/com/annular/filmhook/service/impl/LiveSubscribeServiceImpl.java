...
//					.orElseThrow(() -> new RuntimeException("Channel not found"));
			...
			return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
					.body(new Response(-1, "failed to save live Subscribe", e.getMessage()));
		}
	...
	@Override
	public ResponseEntity<?> getLiveSubcribes(LiveSubscribeWebModel liveSubscribeWebModel) {

	    List<Map<String, Object>> responseList = new ArrayList<>();
	    List<String> userIds = new ArrayList<>();
	    List<LiveSubscribe> subscribeData = liveSubscribeRepository
				.findByChannelId(liveSubscribeWebModel.getLiveChannelId());
