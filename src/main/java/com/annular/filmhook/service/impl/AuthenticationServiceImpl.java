...
//			Optional<User> userData = userRepository.findByUserName(userWebModel.getName(), userWebModel.getUserType());
            ...
            if (!userData.isPresent()) {
                ...
                if (userWebModel.getUserType().equalsIgnoreCase("commonUser") ||
                    ...
                    user.setDob(CalenderUtil.convertDateFormat(CalenderUtil.UI_DATE_FORMAT, CalenderUtil.MYSQL_DATE_FORMAT, userWebModel.getDob()));
...
//						user.setUserAccountName(userWebModel.getUserFirstName() + " " + userWebModel.getUserLastName());
                        ...
                        return ResponseEntity.status(HttpStatus.UNPROCESSABLE_ENTITY).body(new Response(1, "Invalid user type", ""));
                    }
                ...
                return ResponseEntity.status(HttpStatus.UNPROCESSABLE_ENTITY).body(new Response(1, "This Account is already exist", ""));
            }
