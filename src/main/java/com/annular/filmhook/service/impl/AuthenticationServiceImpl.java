...
//			Optional<User> data = userRepository.findByResetPassword(userDetails.userInfo().getId());
        ...
        return ResponseEntity.status(org.springframework.http.HttpStatus.OK).body(new Response(1, "Your password has been changed. Please login with new password.", "Password changed SuccessFully"));
    }
