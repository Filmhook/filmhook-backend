...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.cors()
                ...
                .authorizeRequests(
                        (authorize) -> authorize
                                .antMatchers("/og/post/view/**","/media/**","/report/**","/","/.well-known/**","/user/register","/user/sendEmailOtp","/industryUser/deleteTemporaryDetails", "/user/verifyEmailOtp", "/user/changePassword", "/user/getAddressListOnSignUp", "/user/emailNotification",
                                        ...
                                        "/swagger-resources/**",
                                        "/webjars/**","/audition/payment-failure/**", "/audition/payment-success/**","/deeplink/**","/audition/retry-payment/**", "/api/promote/payment/success", "/api/promote/payment/failure", "/user/refresh-jwt","/ws/**", "/user/forgot-password/**", "/api/security/verifySecurityQuestion/**", "/api/security/changePassword", "/api/security/myQuestions/**")
                                .permitAll()
                                .anyRequest()
                                .authenticated()
                );
